...
import { Layers, Shield, UserCog, MessageSquare, Linkedin } from "lucide-react"
    ...
    return (
        <section id="about" className="bg-[hsl(var(--muted))] section-shell">
            <div className="mx-auto max-w-7xl">
                ...
                {/* Stats */}
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 max-w-5xl mx-auto mb-24">
                    {stats.map((stat) => (
                        <Card
                            key={stat.label}
